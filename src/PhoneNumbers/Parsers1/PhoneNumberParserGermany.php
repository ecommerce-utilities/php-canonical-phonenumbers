...
class PhoneNumberParserGermany implements Parser {
	...
	private $service2 = array(
		'12',  # Innovative Services
	);

	private $service3 = array(
		'130',
		'180', #
		'181', # IVPNs
	...
	public function parsePhoneNumber($countryPhoneCode, $phoneNumber) {
		...
		if((string) $countryPhoneCode === '49') {
			...
			switch (true) {
				case $startsWith($this->service2, 2): list($areaCode, $phoneNumber) = $split($phoneNumber, 2); break;
				case $startsWith($this->service3, 3): list($areaCode, $phoneNumber) = $split($phoneNumber, 3); break;
				case $startsWith($this->service4, 4): list($areaCode, $phoneNumber) = $split($phoneNumber, 4); break;
				case $startsWith($this->mobile_4digits, 4): list($areaCode, $phoneNumber) = $split($phoneNumber, 4); break;
				case $startsWith($this->mobile_3digits, 3): list($areaCode, $phoneNumber) = $split($phoneNumber, 3); break;
				case $startsWith($this->ndcs4, 4): list($areaCode, $phoneNumber) = $split($phoneNumber, 4); break;
				case $startsWith($this->ndcs3, 3): list($areaCode, $phoneNumber) = $split($phoneNumber, 3); break;
				case $startsWith($this->ndcs2, 2): list($areaCode, $phoneNumber) = $split($phoneNumber, 2); break;
			}
